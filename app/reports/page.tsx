...
export default function ReportsPage() {
  ...
  const [feeHouseFilter] = useState("all");
  const [feeResidentStatusFilter] = useState("active");
  const [feeChargeStatusFilter] = useState("open");
  const [feeDueStart] = useState("");
  const [feeDueEnd] = useState("");
  ...
  const [, setPassRequests] = useState<PassRequestRow[]>([]);
